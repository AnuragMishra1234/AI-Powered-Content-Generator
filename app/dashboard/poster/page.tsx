    ...
    <div className="w-full">
      ...
      <div className="p-4 md:p-8">
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div>
            <div className="bg-white dark:bg-slate-800 rounded-lg p-6 border border-gray-200 dark:border-slate-700">
              <h2 className="text-xl font-semibold mb-4">Design Your Poster</h2>
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium mb-2">Poster Title</label>
                  <input
                    type="text"
                    value={title}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Add more details about your poster..."
          ...
          <div>
            {output ? (
              <OutputCard output={output} toolType="poster" isLoading={loading} />
            ) : (
              <div className="bg-white dark:bg-slate-800 rounded-lg p-6 border border-gray-200 dark:border-slate-700 h-full flex items-center justify-center">
                <div className="text-center text-gray-500 dark:text-gray-400">
                  <p className="text-lg mb-2">No poster generated yet</p>
        ...
        <div className="mt-8 bg-amber-100 dark:bg-amber-900/30 p-6 rounded-lg border border-amber-300 dark:border-amber-700">
          <h3 className="font-semibold text-amber-900 dark:text-amber-200 mb-2">💡 Poster Design Tips</h3>
          <ul className="text-sm text-amber-800 dark:text-amber-300 space-y-1">
            <li>• Keep the title short and impactful</li>
            <li>• Include a clear call-to-action</li>
            <li>• Use contrasting colors for visibility</li>
            <li>• Mention date, location, or offer</li>
          </ul>
        </div>
      </div>
    </div>
